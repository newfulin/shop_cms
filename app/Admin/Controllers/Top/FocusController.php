...
class FocusController extends Controller{
    ...
    public function form()
    {
        ...
        return Admin::form(TopLine::class,function(Form $form){
            ...
            $form->display('id','ID');
            $form->hidden('top_type','头条类型')->default('40');
